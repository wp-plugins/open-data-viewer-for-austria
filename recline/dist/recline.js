...
(function(my, $) {
  ...
  my.fetch = function(dataset) {
    ...
    if (dataset.file) {
      ...
      //$.get(dataset.url).done(function(data) {
			$.ajax({url: dataset.url, contentType: 'application/x-www-form-urlencoded; charset=UTF-8'}).done(function(data) {
  ...
  my.parseCSV= function(s, options) {
    ...
    s = chomp(s);
		...
		// Custom delimeter automatic, when delimeter is not set
